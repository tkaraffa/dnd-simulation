...
from utils import images_directory, generate_barbarian_stats
...
def create_chart(
    ...
    fig.write_image(os.path.join(images_directory, filename))
    ...
    for ac in [15, 20, 25]:
        ...
        for level in [5, 10, 15, 20]:
            ...
            axemillion = Barbarian(
                name="Greataxe", damage_dice=(12, 1), **shared_stats
            )
